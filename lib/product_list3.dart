...
class product_list3 extends StatefulWidget {
  const product_list3({super.key});

  @override
  State<product_list3> createState() => _product_list3State();
}

class _product_list3State extends State<product_list3> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xffEFEFEF),
      appBar: AppBar(
          title: Text('Sweets',style:
          TextStyle(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          // mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image(image: AssetImage('assets/gulab-jamun-samosa-indian-cuisine-ras-malai-south-asian-sweets-indian-sweets 1.png'),width: 200,height: 130,),
                            SizedBox(
                              height: 5,
                            ),
